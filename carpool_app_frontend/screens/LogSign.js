...
const SignScreen = ({ navigation }) => {
    ...
    return (
        ...
        <View style={{ flex: 1, alignItems: 'center', backgroundColor: 'silver' }}>
            ...
            <Image style={{ width: 450, height: 180, marginBottom: 0, marginTop: 1 }}

                source={{ uri: 'https://cdn2.vectorstock.com/i/thumb-large/55/76/carsharing-or-carpooling-service-icon-vector-30285576.jpg' }}

            />

            <TextInput style={{ fontSize: 14, color: 'black', width: 200, borderBottomWidth: 2, marginBottom: 0 }}

                placeholder="Enter your email"

            />

            <TextInput style={{ fontSize: 14, borderBottomColor: '#000', color: 'black', width: 200, marginBottom: 0, borderBottomWidth: 2 }}
            ...
            <Text style={{ color: 'black', fontSize: 14, marginBottom: 0 }}>Don't Have an account yet?</Text>
